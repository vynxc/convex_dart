...
pub(crate) const FLUTTER_RUST_BRIDGE_CODEGEN_CONTENT_HASH: i32 = 1320501180;
...
fn pde_ffi_dispatcher_primary_impl(
    ...
    match func_id {
        1 => wire__crate__api__simple__CallbackSubscriber_on_error_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        2 => wire__crate__api__simple__CallbackSubscriber_on_update_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        3 => wire__crate__api__simple__MobileConvexClient_action_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        4 => wire__crate__api__simple__MobileConvexClient_mutation_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ...
        6 => wire__crate__api__simple__MobileConvexClient_query_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        7 => wire__crate__api__simple__MobileConvexClient_set_auth_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        8 => wire__crate__api__simple__SubscriptionHandle_cancel_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
